        ...
        <>
            ...
            <QueryClientProvider client={queryClient}>
                ...
                {/* <div className="w-screen h-screen bg-[#f0f0f0]">
                    <div className="flex flex-col nowrap h-full w-full">
                        <div>
                             <Navbar fluid rounded>
                                ...
                                <Link
                                    onClick={onLogout}
                                    className="text-red-700 font-medium pr-10"
                                >
                                    {" "}
                                    Log Out...
                                </Link>
                        ...
                        <div className="flex flex-row nowrap h-full">
                                                            ...
                                                            <SidebarCollapse
                                                                ...
                                                                className={`${
                                                                    res.children.find(
                                                                        ...
                                                                        ? " bg-emerald-200 text-gray-600 hover:bg-emerald-100"
                                                                        : null
                                                                }`}
                                                            >
                                                                {res.children.map(
